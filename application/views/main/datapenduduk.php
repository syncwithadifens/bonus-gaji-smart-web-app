        ...
        <div class="row mb-2">
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-left">
              <li class="breadcrumb-item" style="color: #0080ff;">Data Penduduk</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="content">
    	<div class="card">
    		<div class="card-body">
				<div class="row">
					<div class="pull-left">
						<a href="<?= base_url('main/tambahdatapenduduk'); ?>" class="btn btn-primary mb-4"><i class="fas fa-plus" style="margin-right: 7px;"></i>Tambah Data Penduduk</a>
					</div>
    			...
    			<table id="table_id" class="table table-striped table-bordered" cellspacing="0" width="100%">
					<thead>
						<tr>
						  <th>No.</th>
						  <th style="min-width: 180px;">Nomor Kartu Keluarga</th>
					...
					<tbody>
						...
						foreach($penduduk as $p) { ?>
							<tr>
								...
								<td style="text-align: left;"><?= $p->no_kk;?></td>
