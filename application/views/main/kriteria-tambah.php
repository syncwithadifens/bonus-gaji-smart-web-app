      ...
      <div class="card-body">
        <div class="col-lg-8">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-7">
              <input type="text" class="form-control" id="nama_kriteria" name="nama_kriteria" placeholder="Contoh: Disiplin" required="" oninvalid="this.setCustomValidity('Kriteria harus diisi')" oninput="setCustomValidity('')">
            </div>
          </div>
          <div class="form-group row">
            <label for="bobot_normalisasi" class="col-sm-2 col-form-label">Bobot</label>
            <div class="col-sm-7">
              <input type="number" class="form-control" id="bobot_normalisasi" name="bobot_normalisasi" placeholder="Contoh: 10" required="" oninvalid="this.setCustomValidity('Bobot harus diisi')" oninput="setCustomValidity('')">
            </div>
          </div>
